    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            Tab(icon: Icon(Icons.local_hospital_outlined), text: 'Facilities'),
      ...
      body: TabBarView(
        controller: _tabCtrl,
        children: const [_FacilitiesTab(), _ProvidersTab(), _ActivityLogsTab()],
      ),
    );
  }
}
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () => _showCreateFacilityAdminDialog(f),
                    ),
                  ),
                );
              },
  ...
  Future<void> _load() async {
    ...
    try {
      final results = await Future.wait([
        _api.dio.get(ApiEndpoints.providers),
        _api.dio.get(ApiEndpoints.facilities),
      ]);
      _providers = results[0].data as List;
      _facilities = results[1].data as List;
    } on DioException catch (e) {
